#### IMPORTANT! sample ID can only have "_", cannot have ".", "/" or "-".
...
p221 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_221.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_221.tricube"),color = "black",size=1)
p222 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_222.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_222.tricube"),color = "black",size=1)
p223 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_223.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_223.tricube"),color = "black",size=1)
p225 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_225.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_225.tricube"),color = "black",size=1)
p229 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_229.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_229.tricube"),color = "black",size=1)
p230 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_230.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_230.tricube"),color = "black",size=1)
p231 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_231.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_231.tricube"),color = "black",size=1)
p233 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_233.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_233.tricube"),color = "black",size=1)
p237 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_237.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_237.tricube"),color = "black",size=1)
p238 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_238.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_238.tricube"),color = "black",size=1)
p239 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_239.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_239.tricube"),color = "black",size=1)
p244 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_244.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_244.tricube"),color = "black",size=1)
p245 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_245.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_245.tricube"),color = "black",size=1)
p246 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_246.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_246.tricube"),color = "black",size=1)
p247 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_247.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_247.tricube"),color = "black",size=1)
p248 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_248.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_248.tricube"),color = "black",size=1)
p249 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_249.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_249.tricube"),color = "black",size=1)
p251 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_251.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_251.tricube"),color = "black",size=1)
p252 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_252.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_252.tricube"),color = "black",size=1)
p253 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_253.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_253.tricube"),color = "black",size=1)
p254 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_254.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_254.tricube"),color = "black",size=1)
p255 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_255.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_255.tricube"),color = "black",size=1)
p256 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_256.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_256.tricube"),color = "black",size=1)
p257 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_257.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_257.tricube"),color = "black",size=1)
p258 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_258.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_258.tricube"),color = "black",size=1)
p259 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_259.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_259.tricube"),color = "black",size=1)
p260 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_260.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_260.tricube"),color = "black",size=1)
p261 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_261.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_261.tricube"),color = "black",size=1)
p262 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_262.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_262.tricube"),color = "black",size=1)
p263 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_263.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_263.tricube"),color = "black",size=1)
p264 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_264.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_264.tricube"),color = "black",size=1)
p265 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_265.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_265.tricube"),color = "black",size=1)
p266 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_266.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_266.tricube"),color = "black",size=1)
p267 <- p0 + geom_point(aes_string(x = "POS", y = "AB_BSA_267.filter"),color = "orange",size=0.5) + geom_line(aes_string(x = "POS", y = "AB_BSA_267.tricube"),color = "black",size=1)
