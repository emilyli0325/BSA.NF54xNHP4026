#combine g.vcf
export PATH=/master/fcheval/local/bin:$PATH
...
--intervals Pf3D7_API_v3:1-34250 --intervals Pf_M76611:1-5967 \
...
-T GenotypeGVCFs \
-R /data/infectious/malaria_XUE/cross/BSA2_lifecycle_drug/NF54_NHP4026/NF54ref/NF54.SNP.fasta \
-V BSA5.NF54-NHP4026.MT.g.vcf \
--useNewAFCalculator \
--sample_ploidy 1 \
-nt 10 \
-o BSA5.NF54-NHP4026.MT.vcf
...
-T SelectVariants \
-R /data/infectious/malaria_XUE/cross/BSA2_lifecycle_drug/NF54_NHP4026/NF54ref/NF54.SNP.fasta \
-V BSA5.NF54-NHP4026.MT.vcf \
-nt 10 \
-selectType SNP -o BSA5.NF54-NHP4026.MT.SNP.vcf
# vcf to table  
java -Xmx50g -jar /master/xli/software/GATK/GenomeAnalysisTK.jar \
-T VariantsToTable \
-R /data/infectious/malaria_XUE/cross/BSA2_lifecycle_drug/NF54_NHP4026/NF54ref/NF54.SNP.fasta \
-V BSA5.NF54-NHP4026.MT.SNP.vcf \
-F CHROM -F POS -F REF -F ALT \
-GF AD \
-o BSA5.NF54-NHP4026.MT.SNP.table
...
-o BSA5.NF54-NHP4026.SNP.filter_wholeGenome.table
